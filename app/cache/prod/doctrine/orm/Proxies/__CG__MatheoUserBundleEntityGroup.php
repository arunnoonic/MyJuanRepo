 ...
 */
class Group extends \Matheo\UserBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     * {@inheritDoc}
     */
    public function setRolesCollection(\Doctrine\Common\Collections\ArrayCollection $roles)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRolesCollection', array($roles));
